...
stringX: .asciiz "\nInserire la larghezza del labirinto [4,6,8,10,12,14,16]: "
stringY: .asciiz "\nInserire l'altezza del labirinto [4,6,8,10,12,14,16]: "
stringS: .asciiz "\nInserire il seed: "

.text
main:

	j reset #genera la stringa di default chiedendo di definire le dimensioni del labirinto
	afterReset:
...
reset:
	...
	la $s2, labirinto 		#carica l'indirizzo di labirinto in $s2
...
rand:	#restituisce in $t0 un valore pseudorandom [0..$a0]
